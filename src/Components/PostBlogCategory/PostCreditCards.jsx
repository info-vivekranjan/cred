...
function PostCreditCards() {
    ...
    const addData = (payload) => {
        ...
        return axios.post("https://json-server-mocker-sm2-196.herokuapp.com/blogCreditCards", payload)
            .then((res) => {
                console.log(res);
                    ...
                    isError ? <h3>Something Went Wrong...</h3> :
                        ...
                        <div className={styles.AllBlogFormCont}>
                            ...
                            <div className={styles.BlogFormCont}>
                                ...
                                <h1 style={{ color: "#420FAA" }}>Post Credit Cards Blog</h1>
