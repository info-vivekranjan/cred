...
function PostCreditCardsPayment() {
    ...
    const addData = (payload) => {
        ...
        return axios.post("https://json-server-mocker-sm2-196.herokuapp.com/blogCreditCardPayment", payload)
            .then((res) => {
                console.log(res);
            })
            .catch((err) => {
                    ...
                    isError ? <h3>Something Went Wrong...</h3> :
                        ...
                        <div className={styles.AllBlogFormCont}>
                            ...
                            <div className={styles.BlogFormCont}>
                                ...
                                <h1 style={{ color: "#E4265B" }}>Post Credit Cards Payment Blog</h1>
                                ...
                                <form onSubmit={formik.handleSubmit}>
                                    ...
                                    <div>
                                        ...
                                        <>
                                            {
                                                showSuccessful ?
                                                    <h2 style={{ color: 'green' }}>You have Posted the Blog Successfully...</h2> : null
                                            }
                                        </>
