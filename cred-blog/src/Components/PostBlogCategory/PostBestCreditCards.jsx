...
function PostBestCreditCards() {
    ...
    const addData = (payload) => {
        ...
        return axios.post("https://json-server-mocker-sm2-196.herokuapp.com/blogBestCreditCards", payload)
            .then((res) => {
                console.log(res);
            })
            .catch((err) => {
                    ...
                    isError ? <h3>Something Went Wrong...</h3> :
                        ...
                        <div className={styles.AllBlogFormCont}>
                            ...
                            <div className={styles.BlogFormCont}>
                                ...
                                <h1 style={{ color: "#E4265B" }}>Post Best Credit Cards Blog</h1>
